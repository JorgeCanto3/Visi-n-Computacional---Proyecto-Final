classdef OperacionesAritmeticas
    methods (Static)
        ...
        % Suma de una imagen con un valor escalar
        ...
        % Resta de un escalar a una imagen
        ...
        % Resta de dos imagenes (Valores reales / negativos permitidos)
        ...
        % Resta de dos imagenes (Absolutas)
        ...
        % Producto de una imagen con un valor escalar
        ...
        % Producto de dos imagenes (Pixel a Pixel)
        ...
        % Division de una imagen entre un valor escalar
        ...
        % Division de dos imagenes (Pixel a Pixel)
